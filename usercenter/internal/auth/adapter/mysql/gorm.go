...
var mysqlAssetsCon *gorm.DB

func InitAssetsMysql(dsn string, maxCon int) {
	mysqlAssetsCon = NewMysql(dsn, maxCon)
	log.Infof("mysqlAssetsCon:%+v,maxCon:%v", mysqlAssetsCon, maxCon)
}
...
func (CasbinRule) TableName() string {
	return "coins_agent_casbin_rule"
}
...
func NewGormAdapter() *GormAdapter {
	a := &GormAdapter{o: mysqlAssetsCon}
...
func (a *GormAdapter) RemovePolicy(sec string, ptype string, rule []string) error {
	...
	do := a.o.Delete(CasbinRule{}, "p_type=? and v0=? and v1=? and v2=? and v3=? and v4=? and v5=?", line.PType,
		line.V0,
		line.V1,
		line.V2,
		line.V3,
...
func (a *GormAdapter) RemoveFilteredPolicy(sec string, ptype string, fieldIndex int, fieldValues ...string) error {
	...
	//	line.V4,
	//	line.V5)
	do := a.o.Delete(CasbinRule{}, params...)
	return do.Error
}
